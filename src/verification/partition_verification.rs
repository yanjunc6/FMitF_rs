...
use crate::cfg::{CfgProgram, FunctionId, HopId, Operand, TableId};
...
impl PartitionVerifier {
    ...
    pub fn set_boogie_output_dir(&mut self, _dir: String) {
        // No-op: verification stage removed, keeping for API compatibility
    }
    ...
    pub fn run_verification(
        ...
        // Verification stage removed - return empty result
        PartitionVerificationResult {
            verified_accesses: Vec::new(),
            cross_partition_accesses: Vec::new(),
            verification_errors: Vec::new(),
            boogie_files_generated: 0,
        }
    }
}
