...
pub enum ResolvedType {
    /// A concrete, built-in type like `int`, `string`, `bool`, `float`
    Primitive(PrimitiveType),
    
    /// A user-defined type
    UserDefined {
        type_id: TypeDeclId,
        /// For generic types like `List<int>`, this contains the concrete type arguments
        type_args: Vec<ResolvedType>,
    },
    
    /// A table type - Table<TableName> where TableName is a table, not a type
    Table {
        table_id: TableId,
    },
    
    /// A type variable for generic parameters (like `T` in `List<T>`)
    TypeVariable {
        var_id: TypeVarId,
    ...
    /// Unknown type (for inference failures or errors)
    Unknown,
}
...
pub struct CallableDecl {
    ...
    pub resolved_return_type: Option<ResolvedType>, // Filled by type resolver
    pub resolved_function_type: Option<ResolvedType>, // Filled by type resolver (full function type)
    pub span: Option<Span>,
}
...
pub struct ConstDecl {
    ...
    pub ty: TypeId,
    pub value: ExprId,
    pub resolved_type: Option<ResolvedType>, // Filled by type resolver
    pub span: Option<Span>,
}
...
pub enum Expression {
    Literal {
        value: Literal,
        resolved_type: Option<ResolvedType>, // Filled by type resolver
        span: Option<Span>,
    },
    ...
    Assignment {
        lhs: ExprId,
        rhs: ExprId,
        resolved_type: Option<ResolvedType>, // Filled by type resolver (usually Void)
        span: Option<Span>,
    },
    ...
    Grouped {
        expr: ExprId,
        resolved_type: Option<ResolvedType>, // Filled by type resolver (same as inner expr)
        span: Option<Span>,
    },
    ...
    Lambda {
        ...
        return_type: TypeId,
        body: BlockId,
        resolved_type: Option<ResolvedType>, // Filled by type resolver (function type)
        span: Option<Span>,
    },
}
